...
const T = {
  fr: {
    badge: '12 villes - 3 agences - Bus & Train',
    ...
    selectFrom: 'Ville de depart', selectTo: 'Destination',
    trainFrom: 'Gare depart', trainTo: 'Gare arrivee',
    selectTrainFrom: 'Gare de depart', selectTrainTo: "Gare d arrivee",
    classes: { all: 'Toutes', normal: 'Normal', vip: 'VIP', classic: 'Classic', second: '2eme', first: '1ere', couchette: 'Couchette' },
  ...
  en: {
    badge: '12 cities - 3 agencies - Bus & Train',
    ...
    selectFrom: 'Departure city', selectTo: 'Destination',
    trainFrom: 'From station', trainTo: 'To station',
    selectTrainFrom: 'Departure station', selectTrainTo: 'Arrival station',
    classes: { all: 'All', normal: 'Normal', vip: 'VIP', classic: 'Classic', second: '2nd', first: '1st', couchette: 'Couchette' },
...
export default function HomePage() {
  ...
  const getTrainLabel = (r: typeof TRAIN_ROUTES[0]) =>
    isMounted && lang === 'en' ? r.typeEn : r.type.charAt(0).toUpperCase() + r.type.slice(1)
  ...
  const tabStyle = (active: boolean): React.CSSProperties => ({
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '-1.5px',
  })
  ...
  return (
    <div style={{ fontFamily: 'var(--nv-font-body)' }}>
            ...
            <div style={{ padding: 'clamp(16px, 4vw, 24px) clamp(16px, 4vw, 28px)' }}>
              {mode === 'bus' ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <button className="nv-btn nv-btn-primary nv-btn-full" onClick={handleBusSearch} style={{ height: '48px', fontSize: '15px', fontWeight: 700 }}>
                    {t.search} &rarr;
                  </button>
                </div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <button className="nv-btn nv-btn-primary nv-btn-full" onClick={handleTrainSearch} style={{ height: '48px', fontSize: '15px', fontWeight: 700 }}>
                    {t.search} &rarr;
                  </button>
                </div>
              )}
      ...
      <section className="nv-section-sm" style={{ background: 'var(--nv-bg-surface)', borderTop: '1.5px solid var(--nv-border)', borderBottom: '1.5px solid var(--nv-border)' }}>
        <div className="nv-container">
          <h2 style={{ fontFamily: 'var(--nv-font-display)', fontSize: 'clamp(18px, 4.5vw, 22px)', fontWeight: 700, color: 'var(--nv-gray-900)', marginBottom: '16px' }}>{t.busRoutes.title}</h2>
      ...
      <section className="nv-section-sm" style={{ background: 'var(--nv-bg-page)' }}>
        <div className="nv-container">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
            <h2 style={{ fontFamily: 'var(--nv-font-display)', fontSize: 'clamp(18px, 4.5vw, 22px)', fontWeight: 700, color: 'var(--nv-gray-900)' }}>{t.trainRoutes.title}</h2>
      ...
      <section className="nv-section" style={{ background: 'var(--nv-bg-surface)', borderTop: '1.5px solid var(--nv-border)' }}>
        <div className="nv-container">
          <h2 style={{ fontFamily: 'var(--nv-font-display)', fontSize: 'clamp(20px, 5vw, 28px)', fontWeight: 700, color: 'var(--nv-gray-900)', marginBottom: '28px', textAlign: 'center' }}>{t.howItWorks.title}</h2>
...
console.log('Written: app/page.tsx — search buttons fully restored!');
