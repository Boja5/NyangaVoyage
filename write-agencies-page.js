...
const agenciesDir = path.join('app', 'agencies');
if (!fs.existsSync(agenciesDir)) fs.mkdirSync(agenciesDir, { recursive: true });
fs.writeFileSync(path.join(agenciesDir, 'page.tsx'), agenciesPage, 'utf8');
console.log('Written: app/agencies/page.tsx');

// Update the Navbar to link to /agencies
...
console.log('Updated: components/Navbar.tsx with /agencies link');

// Also update homepage nav Agences span to a link
...
console.log('Updated: app/page.tsx agencies link');
